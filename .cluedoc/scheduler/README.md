...
미구현 항목이 1개 있습니다. 달력 아래에 표시되는 집중 합주기간 띠는 기간이 2개 이상이어도 시작일이 가장 이른 1개만 표시하는데, 2개 이상을 한 화면에 나란히 표시하는 방법을 아직 정하지 않았기 때문입니다. 화면 전체의 미구현 항목은 [화면](../screens/README.md)이 표로 정리합니다.
