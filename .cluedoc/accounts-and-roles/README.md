...
title: 계정과 역할
sources:
  - frontend/prototypes/login.html   # 로그인·가입·아이디 찾기·비밀번호 찾기·재설정 다섯 화면과 그 입력 검사
---
...
- [화면 프로토타입](../screen-prototypes/README.md) — 아래 다섯 화면이 실제로 그려져 있는 자리
...
**아직 서버에 물려 있지 않다.** 지금 도는 것은 화면 안의 입력 검사뿐이고, 실제로 계정을 만들거나 본인을 확인하는 통로는 없다. 여기 적힌 역할과 권한 규칙은 그 통로가 생길 때 지켜야 할 기준이다. 화면의 현재 상태는 [화면 프로토타입](../screen-prototypes/README.md)에서 함께 다룬다.
