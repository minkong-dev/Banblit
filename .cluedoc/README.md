...
사람은 계정으로 들어와 팀에 소속되고, 할 수 있는 일은 권한 항목 열한 가지를 켜고 끈 permission set이 정합니다. 두 값짜리 역할(헤드매니저/일반멤버)은 없앴습니다. 권한과 소속은 문서에만 적힌 규칙이 아니라 서버가 endpoint마다 확인해 지키는 것이고, 어느 endpoint에 무엇이 필요한지는 [계정과 역할](./accounts-and-roles/README.md)에서 다룹니다.
