...
- [화면 프로토타입](./screen-prototypes/README.md) — 확정된 화면 설계를 실제 서버에 물려 확인하는 자리
...
[계정과 역할] ──▶ [팀과 소속] ──┬──▶ [스케줄러] ◀── [합주실과 기간]
      ...
      ├──────────────▶ [게시판과 공지]
      │
      └──────────────▶ [화면 프로토타입] (위 기능들을 실제 서버에 물려 눈으로 확인하는 자리)
```
...
- **확인**: 화면 프로토타입이 확정된 설계를 실제 서버에 물려, 아직 만들지 않은 통로가 무엇인지 드러낸다.
