...
sources:
  ...
  - backend/tests/integration/db/test_auto_assign.py       # 언제 실행되고 언제 실행되지 않는지의 시나리오
...
```mermaid
flowchart TD
    W[확인 간격마다 실행됩니다] --> P{오늘이 기간 안에 드는<br/>집중 합주기간이 있는가}
