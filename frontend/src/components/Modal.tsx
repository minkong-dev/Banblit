// 팀 만들기, 합주실 관리, 집중 합주기간 설정, 권한 묶음 편집이 모두 같은 레이아웃으로 표시됩니다:
// 제목 줄, 내용, 아래쪽 버튼 줄. 각 화면마다 <dialog> 를 따로 정의하면 한쪽만 고쳐져
// 일관성이 깨지므로, 여기서 공통 modal(화면 위에 뜨는 대화 상자)을 관리합니다.
//
